...
Collect.elements(skinPacksTab, 'skinpack', 'skin-packs', False, True)
Collect.elements(texturePacksTab, 'resourcepack', 'texture-packs', False, True)
Collect.elements(mashUpPacksTab, 'mashup', 'mash-up-packs', False, True)
Collect.elements(adventureMapsTab, 'adventure_world', 'adventure-maps', False, True)
Collect.elements(miniGamesTab, 'mini_game_world', 'mini-games', False, True)
Collect.elements(survivalSpawnsTab, 'survival_spawn_world', 'survival-spawns', False, True)
